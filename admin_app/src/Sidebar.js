...
//         }}
//       >
//                 <DashboardIconOutlined /> {/* Dashboard Icon */}
//               </ListItemIcon>
//               <ListItemText primary={<Typography variant="body1" fontWeight="bold">Dashboard</Typography>} sx={{ opacity: open ? 1 : 0 }} /></ListItemButton>
//           </ListItem>
...
//         }}
//       >
//                   <AssignmentIconOutlined  /> {/* Orders Icon */}
//                 </ListItemIcon>
//                 <ListItemText primary={<Typography variant="body1" fontWeight="bold" marginRight="20px">Orders data</Typography>} sx={{ opacity: open ? 1 : 0 }} /></ListItemButton>
//             </ListItem>
            
//            <ListItem  disablePadding sx={{ display: 'block' }} onClick={() => {navigate("/registerdata")}}>
//               <ListItemButton
//                 sx={{
//                   minHeight: 48,
//                   justifyContent: open ? 'initial' : 'center',
...
//           mr: open ? 3 : 'auto',
//           justifyContent: 'center',
//           color: '#000', // Apply a specific color to the icon
//         }}
//       >
//                   <ReceiptIconOutlined /> {/* Register Data Icon */}
//                 </ListItemIcon>
//                 <ListItemText primary={<Typography variant="body1" fontWeight="bold">Users Register Data</Typography>} sx={{ opacity: open ? 1 : 0 }} /></ListItemButton>
//             </ListItem>


//            <ListItem  disablePadding sx={{ display: 'block' }} onClick={() => {navigate("/adminregisterdata")}}>
//               <ListItemButton
//                 sx={{
//                   minHeight: 48,
//                   justifyContent: open ? 'initial' : 'center',
...
//                   <ReceiptIconOutlined />
//                 </ListItemIcon>
//                 <ListItemText primary={<Typography variant="body1" fontWeight="bold">Admins Register Data</Typography>} sx={{ opacity: open ? 1 : 0 }} /></ListItemButton>
//             </ListItem>
//          </List>
//       </Drawer>
//     </Box>
